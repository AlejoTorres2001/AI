                      ...
                      <div className="px-4 py-6 bg-gray-700 sm:px-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center ml-3 h-7">
                            <button
                              type="button"
                              className="text-gray-200 bg-gray-700 rounded-md hover:text-white focus:outline-none focus:ring-2 focus:ring-white"
                              ...
                              <div className="">
                                <Listbox value={size} onChange={setSize}>
                                  <div className="relative mt-1">
                                    <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-white border border-gray-300 rounded-lg cursor-default focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                                    ...
                                    <Transition
                                      ...
                                      leaveTo="opacity-0"
                                    >
                                      <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white border-gray-700 rounded-md shadow-md max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                        {versions
                                          ? versions.map(
                                              (version, versionIdx) => (
                                                <Listbox.Option
                            ...
                            <div>
                              ...
                              <div className="mt-3">
                                <input
                                  ...
                                  step="0.01"
                                  name="temperature"
                                  className="w-full h-1 bg-gray-100 rounded-lg appearance-none cursor-pointer accent-gray-500"
                                />
                              </div>
                            </div>
                          </div>
